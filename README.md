...
* В linux на данный момент работает не весь фунционал. Для сборки под linux необходимо использовать ветку [webpack](https://github.com/salexdv/bsl_console/tree/webpack)
