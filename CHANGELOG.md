...
* Подсказка полей таблиц с использованием модели запросаv0.3.4
...
* [Объявление типа комментарием](docs/type_hints.md) в синтаксисе строгой типизации EDT — для
...
* Выполнен переход с `webpack 4` на `webpack 5`.
