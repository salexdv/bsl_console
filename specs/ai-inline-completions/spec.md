...
4. Ответ отображается только для той же модели, версии и позиции. Все строки ответа доступны как варианты;
   Tab принимает активную подсказку, Esc скрывает её.
...
- [x] Все варианты актуального ответа доступны через общую панель inline-подсказок.
