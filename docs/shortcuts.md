...
* Переход к определению переменной, функции или поля запроса `CTRL+F12`. Быстрый просмотр определения возможен при наведении курсора мыши на слово с зажатой клавишей `CTRL`, а также при нажатии `CTRL+SHIFT+F10`.
